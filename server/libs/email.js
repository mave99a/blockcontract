...
const email_template = (subject, url) => `
                      ...
                      <tr>
                        <td align="center">
                          <div>
                            ...
                            <w:anchorlock/>
                            <center style="color:#ffffff;font-family:sans-serif;font-size:15px;">View the Contract</center>
                          </v:roundrect><![endif]-->
                            <a href="${url}" class="button button--blue" style="color:#ffffff">View the Contract</a>
                          </div>
                        </td>
                      </tr>
                    </table>
...
function send_one_email(from, to, subject, url, transporter) {
  return new Promise((res, rej) => {
    const mailOptions = {
      ...
      to,
      subject,
      html: email_template(subject, url),
    };
...
module.exports = { send_emails, send_one_email };
